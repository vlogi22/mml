...
%type <s> string
%type <type> basic_data_type argument_data_type declaration_data_type func_type pointer_type void_pointer_type
...
file_var_dec   : tPUBLIC argument_data_type tID opt_init    { $$ = new mml::declaration_node(LINE, tPUBLIC, $2, *$3, $4); }
               ...
               | tFORWARD argument_data_type tID            { $$ = new mml::declaration_node(LINE, tFORWARD, $2, *$3, nullptr); }
...
dec  : argument_data_type tID opt_init       { $$ = new mml::declaration_node(LINE, tPRIVATE, $1, *$2, $3); }
...
func_type : declaration_data_type '<' opt_types '>'      { $$ = cdk::functional_type::create(*$3, $1); }
          ;

basic_data_type     : tTYPE_INT              { $$ = cdk::primitive_type::create(4, cdk::TYPE_INT); }
                    | tTYPE_DOUBLE           { $$ = cdk::primitive_type::create(8, cdk::TYPE_DOUBLE); }
                    | tTYPE_STRING           { $$ = cdk::primitive_type::create(4, cdk::TYPE_STRING); }
                    | func_type              { $$ = $1; }
                    ;

argument_data_type  : tTYPE_INT              { $$ = cdk::primitive_type::create(4, cdk::TYPE_INT); }
                    | tTYPE_DOUBLE           { $$ = cdk::primitive_type::create(8, cdk::TYPE_DOUBLE); }
                    | tTYPE_STRING           { $$ = cdk::primitive_type::create(4, cdk::TYPE_STRING); }
                    | pointer_type           { $$ = $1; }
                    | void_pointer_type      { $$ = $1; }
...
declaration_data_type    : tTYPE_INT              { $$ = cdk::primitive_type::create(4, cdk::TYPE_INT); }
                         | tTYPE_DOUBLE           { $$ = cdk::primitive_type::create(8, cdk::TYPE_DOUBLE); }
                         | tTYPE_STRING           { $$ = cdk::primitive_type::create(4, cdk::TYPE_STRING); }
...
pointer_type   : '[' basic_data_type ']'     { $$ = cdk::reference_type::create(4, $2); }
               | '[' pointer_type ']'        { $$ = cdk::reference_type::create(4, $2); }
               ;

void_pointer_type   : '[' tTYPE_VOID ']'          { $$ = cdk::reference_type::create(4, cdk::primitive_type::create(4, cdk::TYPE_VOID)); }
                    | '[' void_pointer_type ']'   { $$ = $2; }
                    ;
...
type_list : argument_data_type                 { $$ = new std::vector<std::shared_ptr<cdk::basic_type>>(); $$->push_back($1); }
          | type_list ',' argument_data_type   { $$ = $1; $$->push_back($3); }
          ;
...
argdec    : declaration_data_type tID   { $$ = new mml::declaration_node(LINE, tPRIVATE, $1, *$2, nullptr); }
          ;
...
func_def  : '(' opt_argdecs ')' tARROW  declaration_data_type block { $$ = new mml::function_definition_node(LINE, $2, $5, $6); }
          ;
